...
Future<Albums> createAlbum(String productName) async {
  final http.Response response = await http.post(
    Uri.parse(https://shippingdelivery.onrender.com/product/id'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body: jsonEncode(
        <String, String>{'name': productName, 'productCase': 'representative'}),
  );
...
class RepresentativePage extends StatefulWidget {
  @override
  _RepresentativePage createState() => _RepresentativePage();
}

class _RepresentativePage extends State<RepresentativePage> {
  String productId = '';
  String result = '';
  String results = '';
